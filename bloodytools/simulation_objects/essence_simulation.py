...
def essence_simulation(settings: object) -> None:
  ...
  for fight_style in settings.fight_styles:
    for wow_class, wow_spec in specs:
          ...
          for essence_type in range(0, 2):
            ...
            logger.debug((
              "Added azerite essence '{}:{}:{}' in profile '{}' to simulation_group.".format(
                essence_id, rank, essence_type, simulation_data.name
              )
            ))
      ...
      logger.info("Start {} essence simulation for {} {}.".format(fight_style, wow_class, wow_spec))
      try:
        ...
        logger.error("{} essence simulation for {} {} failed. {}".format(fight_style.title(), wow_class, wow_spec, e))
        continue
      else:
        logger.info(
