...
def azerite_trait_simulations(settings) -> None:
  ...
  for fight_style in settings.fight_styles:
    for wow_class, wow_spec in specs:
      ...
      basic_profile_string = create_basic_profile_string(wow_class, wow_spec, settings.tier, settings)
      ...
      # save data to json
      wanted_data = create_base_json_dict("Azerite Traits", wow_class, wow_spec, fight_style, settings)
