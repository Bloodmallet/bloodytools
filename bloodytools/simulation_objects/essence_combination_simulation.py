...
def essence_combination_simulation(settings: object) -> None:
    ...
    for fight_style in settings.fight_styles:
        for wow_class, wow_spec in specs:
            ...
            for major_essence_id in essences.keys():
                ...
                for minor_essence_id in essences.keys():
                    ...
                    simulation_data = Simulation_Data(
                        ...
                        simc_arguments=[
                            "azerite_essences={}:{}:1/{}:{}:0".format(
                                major_essence_id, rank, minor_essence_id, rank
                            )
                        ],
                        target_error=settings.target_error[fight_style],
                        ptr=settings.ptr,
                    ...
                    logger.debug((
                        ...
                        .format(major_essence_id, rank, minor_essence_id, simulation_data.name)
                    ))
            ...
            logger.info(
                "Start {} essence combination simulation for {} {}.".format(
            ...
            try:
                ...
                logger.error(
                    "{} essence simulation combination for {} {} failed. {}".format(
                ...
                logger.info(
                    "{} essence combination simulation for {} {} ended successfully. Cleaning up."
            ...
            for profile in simulation_group.profiles:
                ...
                if not major_essence_name in wanted_data['spell_ids']:
                    wanted_data['spell_ids'][major_essence_name] = essences[str(major_essence_id)
                                                                            ]['major']['spell_id']

                if not minor_essence_name in wanted_data['spell_ids']:
                    wanted_data['spell_ids'][minor_essence_name + ' minor'] = essences[
                        str(minor_essence_id)]['minor']['spell_id']
                ...
                if not major_essence_name in wanted_data[power_id_name]:
                    wanted_data[power_id_name][major_essence_name] = wow_lib.get_essence_power_id(
                        major_essence_id
                    )
                ...
                if not "{} {}".format(minor_essence_name, 'minor') in wanted_data[power_id_name]:
                    wanted_data[power_id_name][
                        minor_essence_name +
                        ' minor'] = wow_lib.get_essence_power_id(minor_essence_id)
