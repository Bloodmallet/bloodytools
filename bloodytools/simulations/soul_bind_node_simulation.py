...
def soul_bind_node_simulation(settings: object) -> None:
    ...
    Returns:
        None --
    """
    logger.debug("soul_bind_node_simulation start")
    ...
    for fight_style in settings.fight_styles:
        for wow_spec in specs:
            ...
            with open(
                ...
                logger.debug("Print soul bind nodes json.")
                f.write(
                    json.dumps(
                        wanted_data,
                        sort_keys=True,
                ...
                logger.debug("Printed soul bind nodes json.")

    logger.debug("soul_bind_node_simulation ended")
